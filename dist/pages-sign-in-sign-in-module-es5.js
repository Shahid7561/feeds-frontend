...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-sign-in-sign-in-module"], {
  ...
  function srcAppPagesSignInSignInComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _theme_utils_common_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var SignInComponent = /*#__PURE__*/function () {
      function SignInComponent(formBuilder, commonService, router, snackBar) {
      ...
      _createClass(SignInComponent, [{
        ...
        value: function onLoginFormSubmit(values) {
          ...
          if (this.loginForm.valid) {
            ...
            this.commonService.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["account"].login, data).subscribe(function (res) {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        console.log(res);
                        this.snackBar.open('You logged successfully!', '×', {
                          panelClass: 'success',
        ...
        value: function onRegisterFormSubmit(values) {
          ...
          if (this.registerForm.valid) {
            this.commonService.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["account"].register, this.registerForm.value).subscribe(function (res) {
                    ...
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        this.commonService.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["account"].login, data).subscribe(function (res) {
                          ...
                          _this3.snackBar.open(err.message, '×', {
                            panelClass: 'danger',
                            verticalPosition: 'top',
                            duration: 3000
                          });
              ...
              _this2.snackBar.open(err.message, '×', {
                panelClass: 'danger',
                verticalPosition: 'top',
                duration: 3000
              });
    ...
    }), __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _theme_utils_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"]])], SignInComponent);
    /***/
  },
